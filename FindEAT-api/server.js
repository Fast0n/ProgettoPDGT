...
app.get('/', function (req, res) {
    ...
    function richiesta(google_key) {
        ...
        if (req.query.tipo == 'luogo' && req.query.lista != undefined) {
            ...
            var uri = 'https://maps.googleapis.com/maps/api/place/textsearch/json?query=ristoranti+a+' + req.query.lista + '&key=' + google_key
        ...
        if (req.query.tipo == 'diretto' && req.query.lista != undefined) {
            ...
            var uri = 'https://maps.googleapis.com/maps/api/place/textsearch/json?query=' + req.query.lista + '&key=' + google_key
            var options = {
                uri: uri,
                json: true
    ...
    function diretto(luogo) {
        ...
        var uri = 'https://maps.googleapis.com/maps/api/place/details/json?placeid=' + luogo + '&language=it&key=' + google_key
        var options = {
            uri: uri,
            json: true
